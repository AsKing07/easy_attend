          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<Filiere>(
                ...
                items:
                    Allfilieres.map<DropdownMenuItem<Filiere>>((Filiere value) {
              ...
              TextFormField(
                  ...
                  style: GoogleFonts.poppins(color: AppColors.textColor),
                  decoration: InputDecoration(
                    labelText: 'Identifiant/Sigle du cours (Par exemple "BDA")',
                    prefixIcon: const Icon(Icons.school),
                    contentPadding: const EdgeInsets.only(top: 10),
                    border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(10.0),
              ...
              GFButton(
                onPressed: () async {
                  if (_formKey.currentState!.validate()) {
                    // Créer le cours
                    setState(() {
                      currentCourse!.nomCours = _nomCoursController.text;
                      currentCourse!.niveau = _selectedNiveau;
                      currentCourse!.filiereId = _selectedFiliere!.idDoc;
                      currentCourse!.professeurId = _selectedProf!.idDoc;
                      currentCourse!.idCours = _idCoursController.text;
                    });

                    await set_Data().modifierCours(currentCourse!, context);
                    widget.callback();
                  } else {
                    GFToast.showToast("Tous les champs sont requis", context,
                  ...
                  Row(
                    children: [
                      const Expanded(
                          ...
                          child: Column(
                            children: [
                              Text("Modifier les informations du cours"),
                              SizedBox(
                                height: 10,
                              ),
                              SizedBox(
